 ...
 * @param {String} countryCode - optional (default: us)
 ...
 * @return {type}
 */
var GooglePlay = (function GooglePlay(username, password, androidId, countryCode, useCache, debug, requestsDefaultParams) {
  // default for args:
  ...
  DEVICE_COUNTRY = LOGIN_LANGUAGE = OPERATOR_COUNTRY = countryCode || "us";
